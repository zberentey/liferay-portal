		...
		fileEntryToolbarChildren.push(
			{
				...
				handler: function(event) {
					if (confirm('<%= UnicodeLanguageUtil.get(pageContext, "are-you-sure-you-want-to-move-this-entry-to-trash") %>')) {
				...
				icon: 'delete',
				label: '<%= UnicodeLanguageUtil.get(pageContext, "move-to-trash") %>'
			}
		);
	</c:if>
