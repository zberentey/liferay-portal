...
<c:choose>
	...
	<c:when test='<%= tabs4.equals("merge-pages") %>'>
		...
		<liferay-ui:message arguments="<%= HtmlUtil.escape(companyGroup.getDescriptiveName(locale)) %>" key="you-can-configure-the-top-level-pages-of-this-public-site-to-merge-with-the-top-level-pages-of-the-public-x-site" />
		...
		<tr>
			<td class="lfr-label">
				<liferay-ui:message arguments="<%= HtmlUtil.escape(companyGroup.getDescriptiveName(locale)) %>" key="merge-x-public-pages" />
			</td>
			<td>
