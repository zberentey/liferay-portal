...
create index IX_AE5FB02B on MBMessage (userId, threadId);
create index IX_5B6C9411 on MBMessage (userId, threadId, status);
...
create index IX_99CB0AE9 on MBThread (companyId, status);
