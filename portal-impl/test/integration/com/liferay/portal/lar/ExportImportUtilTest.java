...
public class ExportImportUtilTest {
	...
	public void setUp() throws Exception {
		...
		_parentStagedModel = JournalTestUtil.addArticle(
	...
	public void testExportDLReferences() throws Exception {
		...
		content = ExportImportUtil.exportContentReferences(
			_portletDataContextExport, _parentStagedModel,
	...
	public void testImportDLReferences() throws Exception {
		...
		content = ExportImportUtil.exportContentReferences(
			_portletDataContextExport, _parentStagedModel, entryElement,
			content);
	...
	private StagedModel _parentStagedModel;
