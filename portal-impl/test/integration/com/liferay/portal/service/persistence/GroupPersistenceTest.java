...
public class GroupPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newGroup.setStagingGroupCount(ServiceTestUtil.nextInt());
		...
		Assert.assertEquals(existingGroup.getStagingGroupCount(),
			newGroup.getStagingGroupCount());
	}
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("Group_", "uuid", true,
			...
			"site", true, "active", true, "stagingGroupCount", true);
	}
	...
	protected Group addGroup() throws Exception {
		...
		group.setStagingGroupCount(ServiceTestUtil.nextInt());
