...
public class JournalArticleLocalServiceImpl
	...
	public void deleteArticle(
		...
		if (articleResource != null) {
			...
			systemEventLocalService.addSystemEvent(
				0, article.getGroupId(), article.getCompanyId(),
	...
	public void deleteArticle(
		...
		systemEventLocalService.addSystemEvent(
			0, groupId, companyId, JournalArticle.class.getName(),
			articleResource.getResourcePrimKey(), null,
			articleResource.getUuid(), SystemEventConstants.TYPE_DELETE,
			StringPool.BLANK);
	}
