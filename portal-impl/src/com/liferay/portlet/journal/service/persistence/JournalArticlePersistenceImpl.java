...
public class JournalArticlePersistenceImpl extends BasePersistenceImpl<JournalArticle>
	...
	public int countByG_U_C_NotS(long groupId, long userId, long classNameId,
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_U_C_NOTS,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_U_C_NOTS,
					finderArgs, count);
