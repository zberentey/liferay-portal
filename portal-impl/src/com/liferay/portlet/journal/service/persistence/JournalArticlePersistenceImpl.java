...
public class JournalArticlePersistenceImpl extends BasePersistenceImpl<JournalArticle>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_U_NOTS = new FinderPath(JournalArticleModelImpl.ENTITY_CACHE_ENABLED,
			JournalArticleModelImpl.FINDER_CACHE_ENABLED,
			JournalArticleImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_U_NotS",
			new String[] {
	...
	/**
	 * Returns all the journal articles where groupId = &#63; and userId = &#63; and status &ne; &#63;.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param status the status
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<JournalArticle> findByG_U_NotS(long groupId, long userId,
		int status) throws SystemException {
	...
	/**
	 * Returns a range of all the journal articles where groupId = &#63; and userId = &#63; and status &ne; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the journal articles where groupId = &#63; and userId = &#63; and status &ne; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	/**
	 * Returns the first journal article in the ordered set where groupId = &#63; and userId = &#63; and status &ne; &#63;.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param status the status
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public JournalArticle findByG_U_NotS_First(long groupId, long userId,
		int status, OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		JournalArticle journalArticle = fetchByG_U_NotS_First(groupId, userId,
				status, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public JournalArticle fetchByG_U_NotS_First(long groupId, long userId,
		int status, OrderByComparator orderByComparator)
		throws SystemException {
		List<JournalArticle> list = findByG_U_NotS(groupId, userId, status, 0,
				1, orderByComparator);
	...
	/**
	 * Returns the last journal article in the ordered set where groupId = &#63; and userId = &#63; and status &ne; &#63;.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param status the status
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public JournalArticle findByG_U_NotS_Last(long groupId, long userId,
		int status, OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		JournalArticle journalArticle = fetchByG_U_NotS_Last(groupId, userId,
				status, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public JournalArticle fetchByG_U_NotS_Last(long groupId, long userId,
		int status, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByG_U_NotS(groupId, userId, status);

		List<JournalArticle> list = findByG_U_NotS(groupId, userId, status,
				count - 1, count, orderByComparator);
	...
	/**
	 * Returns the journal articles before and after the current journal article in the ordered set where groupId = &#63; and userId = &#63; and status &ne; &#63;.
	 *
	 * @param id the primary key of the current journal article
	 * @param groupId the group ID
	 * @param userId the user ID
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public JournalArticle[] findByG_U_NotS_PrevAndNext(long id, long groupId,
		...
		try {
			...
			array[0] = getByG_U_NotS_PrevAndNext(session, journalArticle,
					groupId, userId, status, orderByComparator, true);

			array[1] = journalArticle;

			array[2] = getByG_U_NotS_PrevAndNext(session, journalArticle,
	...
	protected JournalArticle getByG_U_NotS_PrevAndNext(Session session,
		JournalArticle journalArticle, long groupId, long userId, int status,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Returns all the journal articles that the user has permission to view where groupId = &#63; and userId = &#63; and status &ne; &#63;.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param status the status
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<JournalArticle> filterFindByG_U_NotS(long groupId, long userId,
		int status) throws SystemException {
	...
	/**
	 * Returns a range of all the journal articles that the user has permission to view where groupId = &#63; and userId = &#63; and status &ne; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the journal articles that the user has permissions to view where groupId = &#63; and userId = &#63; and status &ne; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	/**
	 * Returns the journal articles before and after the current journal article in the ordered set of journal articles that the user has permission to view where groupId = &#63; and userId = &#63; and status &ne; &#63;.
	 *
	 * @param id the primary key of the current journal article
	 * @param groupId the group ID
	 * @param userId the user ID
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public JournalArticle[] filterFindByG_U_NotS_PrevAndNext(long id,
		long groupId, long userId, int status,
		OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_U_NotS_PrevAndNext(id, groupId, userId, status,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_U_NotS_PrevAndNext(session, journalArticle,
					groupId, userId, status, orderByComparator, true);

			array[1] = journalArticle;

			array[2] = filterGetByG_U_NotS_PrevAndNext(session, journalArticle,
					groupId, userId, status, orderByComparator, false);
	...
	protected JournalArticle filterGetByG_U_NotS_PrevAndNext(Session session,
		JournalArticle journalArticle, long groupId, long userId, int status,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the journal articles where groupId = &#63; and userId = &#63; and status &ne; &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param status the status
	...
	public void removeByG_U_NotS(long groupId, long userId, int status)
		throws SystemException {
		for (JournalArticle journalArticle : findByG_U_NotS(groupId, userId,
				status)) {
			remove(journalArticle);
		}
	}
	...
	/**
	 * Returns the number of journal articles where groupId = &#63; and userId = &#63; and status &ne; &#63;.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param status the status
	...
	/**
	 * Returns the number of journal articles that the user has permission to view where groupId = &#63; and userId = &#63; and status &ne; &#63;.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param status the status
	...
	private static final String _FINDER_COLUMN_G_U_NOTS_GROUPID_2 = "journalArticle.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_U_NOTS_USERID_2 = "journalArticle.userId = ? AND ";
	private static final String _FINDER_COLUMN_G_U_NOTS_STATUS_2 = "journalArticle.status != ?";
