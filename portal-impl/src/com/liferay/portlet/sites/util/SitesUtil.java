...
public class SitesUtil {
		...
		if (Validator.isNotNull(sourcePrototypeLayoutUuid)) {
			...
			Layout _layout =
				LayoutUtil.findByUUID_G(
					sourcePrototypeLayoutUuid, _group.getGroupId());

			SitesUtil._mergeLayoutProtypeLayout(_group, _layout);
		}

		SitesUtil._mergeLayoutProtypeLayout(group, layout);
	...
	private static void _mergeLayoutProtypeLayout(Group group, Layout layout)
		throws Exception {
