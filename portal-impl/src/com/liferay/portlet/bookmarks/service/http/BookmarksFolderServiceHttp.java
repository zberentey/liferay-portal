...
public class BookmarksFolderServiceHttp {
	...
	public static void subscribeFolder(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(BookmarksFolderServiceUtil.class.getName(),
					"subscribeFolder", _subscribeFolderParameterTypes10);
	...
	public static void unsubscribeFolder(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(BookmarksFolderServiceUtil.class.getName(),
					"unsubscribeFolder", _unsubscribeFolderParameterTypes11);
	...
	public static com.liferay.portlet.bookmarks.model.BookmarksFolder updateFolder(
		...
		try {
			MethodKey methodKey = new MethodKey(BookmarksFolderServiceUtil.class.getName(),
					"updateFolder", _updateFolderParameterTypes15);
	...
	private static final Class<?>[] _subscribeFolderParameterTypes10 = new Class[] {
			long.class, long.class
		};
	private static final Class<?>[] _unsubscribeFolderParameterTypes11 = new Class[] {
			long.class, long.class
		};
	...
	private static final Class<?>[] _updateFolderParameterTypes15 = new Class[] {
