...
public class BookmarksEntryLocalServiceImpl
	...
	public boolean isBookmarksEntryRestorable(long entryId)
		...
		return bookmarksFolderLocalService.isFolderRestorable(
	...
	public BookmarksEntry moveEntryFromTrash(
			long userId, BookmarksEntry entry, long parentFolderId)
		throws PortalException, SystemException {

		restoreEntryFromTrash(userId, entry.getEntryId());

		return moveEntry(entry.getEntryId(), parentFolderId);
	}
