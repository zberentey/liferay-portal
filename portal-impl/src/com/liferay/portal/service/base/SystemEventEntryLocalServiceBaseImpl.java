...
/**
 * Provides the base implementation for the system event entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.portal.service.impl.SystemEventEntryLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class SystemEventEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SystemEventEntryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.portal.service.SystemEventEntryLocalServiceUtil} to access the system event entry local service.
	 */
	...
	@Override
	public SystemEventEntry addSystemEventEntry(
		SystemEventEntry systemEventEntry) throws SystemException {
		systemEventEntry.setNew(true);

		return systemEventEntryPersistence.update(systemEventEntry);
	}
	 ...
	 */
	@Override
	public SystemEventEntry createSystemEventEntry(long systemEventId) {
		return systemEventEntryPersistence.create(systemEventId);
	}
	...
	@Override
	public SystemEventEntry deleteSystemEventEntry(long systemEventId)
		throws PortalException, SystemException {
		return systemEventEntryPersistence.remove(systemEventId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SystemEventEntry deleteSystemEventEntry(
		SystemEventEntry systemEventEntry) throws SystemException {
		return systemEventEntryPersistence.remove(systemEventEntry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SystemEventEntry.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return systemEventEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return systemEventEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	@Override
	public SystemEventEntry fetchSystemEventEntry(long systemEventId)
		throws SystemException {
		return systemEventEntryPersistence.fetchByPrimaryKey(systemEventId);
	}
	 ...
	 */
	@Override
	public SystemEventEntry getSystemEventEntry(long systemEventId)
		throws PortalException, SystemException {
		return systemEventEntryPersistence.findByPrimaryKey(systemEventId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return systemEventEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SystemEventEntry> getSystemEventEntries(int start, int end)
		throws SystemException {
		return systemEventEntryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSystemEventEntriesCount() throws SystemException {
		return systemEventEntryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SystemEventEntry updateSystemEventEntry(
		SystemEventEntry systemEventEntry) throws SystemException {
		return systemEventEntryPersistence.update(systemEventEntry);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.portal.model.SystemEventEntry",
			systemEventEntryLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.portal.model.SystemEventEntry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = systemEventEntryPersistence.getDataSource();
