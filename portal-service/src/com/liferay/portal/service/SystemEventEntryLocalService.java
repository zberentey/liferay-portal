...
/**
 * Provides the local service interface for SystemEventEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SystemEventEntryLocalServiceUtil
...
public interface SystemEventEntryLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SystemEventEntryLocalServiceUtil} to access the system event entry local service. Add custom service methods to {@link com.liferay.portal.service.impl.SystemEventEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public void addEvent(long groupId, long userId, int eventType,
